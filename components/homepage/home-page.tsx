...
const HomepageGameCreatedPanel = dynamic(() =>
  import("@/components/homepage/homepage-game-created-panel").then(
    (mod) => mod.HomepageGameCreatedPanel,
  ),
);

const HomepageBelowFoldSections = dynamic(() =>
  import("@/components/homepage/homepage-below-fold-sections").then(
    (mod) => mod.HomepageBelowFoldSections,
  ),
);
    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
      ...
      <main className="relative z-10">
        ...
        <HomepageBelowFoldSections
          ...
          onScrollToCreateGame={scrollToCreateGame}
        />
      </main>
